  ...
  return (
    ...
    >
      <div style={{ width: '100%', maxWidth: '1000px' }}>
        <h1
          style={{ textAlign: 'left', color: '#6c63ff' }}
          id="terms-and-conditions"
        >
          TERMS AND CONDITIONS
        </h1>
        <p>
          <strong>Last updated September 25, 2021</strong>
        </p>
        <h2
          style={{ textAlign: 'left', color: '#6c63ff' }}
        ...
        <p>
          ...
          you, whether personally or on behalf of an entity (“you”) and CONNECT
          (&quot; <strong>Company</strong> ,&quot; “ <strong>we</strong> ,&quot;
          “ <strong>us</strong> ,&quot; or “ <strong>our</strong> ”), concerning
          your access to and use of the quiz-connect.io website as well as any
          ...
          “Site”). We are registered in Canada and have our registered office in
          Montreal, Quebec. You agree that by accessing the Site, you have read,
        ...
        <h2 style={{ textAlign: 'left', color: '#6c63ff' }} id="submissions">
          SUBMISSIONS
        </h2>
        <p>
        ...
        <h2 style={{ textAlign: 'left', color: '#6c63ff' }} id="advertisers">
          ADVERTISERS
        </h2>
        <p>
          ...
          rights. We simply provide the space to place suchadvertisements, and
        ...
        <h2 style={{ textAlign: 'left', color: '#6c63ff' }} id="governing-law">
          GOVERNING LAW
        </h2>
        <p>
          These Terms shall be governed by and defined following the laws of
          Canada. CONNECT and yourself irrevocably consent that the courts of
        ...
        <p>
          ...
          Montreal, Canada.The language of the proceedings shall be English. The
        ...
        <h2 style={{ textAlign: 'left', color: '#6c63ff' }} id="corrections">
          CORRECTIONS
        </h2>
        <p>
        ...
        <h2 style={{ textAlign: 'left', color: '#6c63ff' }} id="disclaimer">
          DISCLAIMER
        </h2>
        <h3 id="the-site-is-provided-on-an-as-is-and-as-available-basis-you-agree-that">
          THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE
          THAT
        </h3>
        <h3 id="your-use-of-the-site-and-our-services-will-be-at-your-sole-risk-to-the">
          YOUR USE OF THE SITE AND OUR SERVICES WILL BE AT YOUR SOLE RISK. TO
          THE
        </h3>
        <h3 id="fullest-extent-permitted-by-law-we-disclaim-all-warranties-express-or">
          FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS
          OR
        </h3>
        <h3 id="implied-in-connection-with-the-site-and-your-use-thereof-including-">
          IMPLIED, IN CONNECTION WITH THE SITE AND YOUR USE THEREOF, INCLUDING,
        </h3>
        <h3 id="without-limitation-the-implied-warranties-of-merchantability-fitness-for">
          WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS
          FOR
        </h3>
        <h3 id="a-particular-purpose-and-non-infringement-we-make-no-warranties-or">
          A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE MAKE NO WARRANTIES OR
        </h3>
        <h3 id="representations-about-the-accuracy-or-completeness-of-the-site-s">
          REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE SITE’S
        </h3>
        <h3 id="content-or-the-content-of-any-websites-linked-to-the-site-and-we-will">
          CONTENT OR THE CONTENT OF ANY WEBSITES LINKED TO THE SITE AND WE WILL
        </h3>
        <h3 id="assume-no-liability-or-responsibility-for-any-1-errors-mistakes-or">
          ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY (1) ERRORS, MISTAKES, OR
        </h3>
        <h3 id="inaccuracies-of-content-and-materials-2-personal-injury-or-property">
          INACCURACIES OF CONTENT AND MATERIALS, (2) PERSONAL INJURY OR PROPERTY
        </h3>
        <h3 id="damage-of-any-nature-whatsoever-resulting-from-your-access-to-and">
          DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND
        </h3>
        <h3 id="use-of-the-site-3-any-unauthorized-access-to-or-use-of-our-secure">
          USE OF THE SITE, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE
        </h3>
        <h3 id="servers-and-or-any-and-all-personal-information-and-or-financial">
          SERVERS AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL
        </h3>
        <h3 id="information-stored-therein-4-any-interruption-or-cessation-of">
          INFORMATION STORED THEREIN, (4) ANY INTERRUPTION OR CESSATION OF
        </h3>
        <h3 id="transmission-to-or-from-the-site-5-any-bugs-viruses-trojan-horses-or">
          TRANSMISSION TO OR FROM THE SITE, (5) ANY BUGS, VIRUSES, TROJAN
          HORSES, OR
        </h3>
        <h3 id="the-like-which-may-be-transmitted-to-or-through-the-site-by-any-third">
          THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SITE BY ANY THIRD
        </h3>
        <h3 id="party-and-or-6-any-errors-or-omissions-in-any-content-and-materials-or">
          PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS
          OR
        </h3>
        <h3 id="for-any-loss-or-damage-of-any-kind-incurred-as-a-result-of-the-use-of">
          FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF
        </h3>
        <h3 id="any-content-posted-transmitted-or-otherwise-made-available-via-the">
          ANY CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE
        </h3>
        <h3 id="site-we-do-not-warrant-endorse-guarantee-or-assume-responsibility">
          SITE. WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY
        </h3>
        <h3 id="for-any-product-or-service-advertised-or-offered-by-a-third-party">
          FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY
        </h3>
        <h3 id="through-the-site-any-hyperlinked-website-or-any-website-or-mobile">
          THROUGH THE SITE, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE
        </h3>
        <h3 id="application-featured-in-any-banner-or-other-advertising-and-we-will-not">
          APPLICATION FEATURED IN ANY BANNER OR OTHER ADVERTISING, AND WE WILL
          NOT
        </h3>
        <h3 id="be-a-party-to-or-in-any-way-be-responsible-for-monitoring-any">
          BE A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR MONITORING ANY
        </h3>
        <h3 id="transaction-between-you-and-any-third-party-providers-of-products-or">
          TRANSACTION BETWEEN YOU AND ANY THIRD-PARTY PROVIDERS OF PRODUCTS OR
        </h3>
        <h3 id="services-as-with-the-purchase-of-a-product-or-service-through-any">
          SERVICES. AS WITH THE PURCHASE OF A PRODUCT OR SERVICE THROUGH ANY
        </h3>
        <h3 id="medium-or-in-any-environment-you-should-use-your-best-judgment-and">
          MEDIUM OR IN ANY ENVIRONMENT, YOU SHOULD USE YOUR BEST JUDGMENT AND
        </h3>
        <h3 id="exercise-caution-where-appropriate-">
        ...
        <h3 id="in-no-event-will-we-or-our-directors-employees-or-agents-be-liable-to">
          IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE
          TO
        </h3>
        <h3 id="you-or-any-third-party-for-any-direct-indirect-consequential-">
          YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL,
        </h3>
        <h3 id="exemplary-incidental-special-or-punitive-damages-including-lost-profit-">
          EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST
          PROFIT,
        </h3>
        <h3 id="lost-revenue-loss-of-data-or-other-damages-arising-from-your-use-of">
          LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF
        </h3>
        <h3 id="the-site-even-if-we-have-been-advised-of-the-possibility-of-such-damages-">
        ...
        <h2 style={{ textAlign: 'left', color: '#6c63ff' }} id="user-data">
          USER DATA
        </h2>
        <p>
        ...
        <h2
          style={{ textAlign: 'left', color: '#6c63ff' }}
          id="electronic-communications-transactions-and"
        >
          ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND
        </h2>
        <h2 style={{ textAlign: 'left', color: '#6c63ff' }} id="signatures">
          SIGNATURES
        </h2>
        <p>
        ...
        <h2 style={{ textAlign: 'left', color: '#6c63ff' }} id="miscellaneous">
          MISCELLANEOUS
        </h2>
        <p>
        ...
        <h2 style={{ textAlign: 'left', color: '#6c63ff' }} id="contact-us">
          CONTACT US
        </h2>
        <p>
        ...
        <p>
          <strong>CONNECT Montreal, Quebec Canada</strong>
        </p>
        <p>
          <strong>support@quiz-connect.io</strong>
        </p>
        <p>©2020-2022 CONNECT. All rights reserved.</p>
      </div>
    </div>
  )
}

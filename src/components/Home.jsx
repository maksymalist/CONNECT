      ...
      <div>
        <div id="homePageDivPurple" className="homePageDivPurple">
          ...
          <div id="homePageDivWhite" className="homePageDivWhite">
            <img
              style={{ width: "100vw", height: "auto", marginTop: "-40px" }}
              src={HomePageWave}
              className="homePageWave"
              alt="homePageWave"
            />
            <h2 className="homepage-text-medium" style={{ maxWidth: "250px" }}>
            ...
            <br />
            <br />
            <h3 className="homepage-text-small" style={{ maxWidth: "250px" }}>
        ...
        <div className="newdiv2">
          ...
          <div className="purpleAboutDiv">
            <Typography variant="h2" style={{ color: "white" }}>
              <strong>{Translations[userLanguage].home.about.title}</strong>
            </Typography>

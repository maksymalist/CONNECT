...
function NotificationBox() {
    ...
    return (
        <div className='notification__box'>
            ...
            <div>
                <Button style={{margin:'10px'}} variant="contained" color="secondary" className="notification__card__button" onClick={()=>handleClearNotifications()}>{Translations[userLanguage].notifications.clear}</Button>
            </div>
        </div>
    )
}

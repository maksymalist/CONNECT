        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <b>{translations.hostroom.quizcompleted}</b>
              </Typography>
            </div>
            <div
              style={{
            ...
            >
              ...
              >
                <b>{translations.hostroom.displayingwinners}</b>
              </Typography>
              <LinearProgress
                variant="determinate"
                  ...
                  <>
                    ...
                    >
                      ...
                      <div className="lowest-time-box">
                        <Typography variant="h3">
                          {lowestTimesState[0]?.player !== undefined
                    ...
                    >
                      ...
                      <div className="lowest-time-box">
                        <Typography variant="h3">
                          {lowestTimesState[1]?.player !== undefined
                    ...
                    >
                      ...
                      <div className="lowest-time-box">
                        <Typography variant="h3">
                          {lowestTimesState[2]?.player !== undefined

...
export default function ThanksForPurchasingAnimation() {
    ...
    return (
        ...
        <div id='popUpCard'>
            ...
            <p className="success">{Translations[userLanguage].thanksforpurchasing.title}</p>
            <Button href='/' style={{marginTop:'1vh', marginBottom:'1vh'}} variant="contained" color="primary" size='small'>{Translations[userLanguage].thanksforpurchasing.button}</Button>
        </div>
        </div>
    )
}

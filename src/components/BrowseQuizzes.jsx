...
export default function BrowseQuizzes() {
    ...
    return (
        ...
        <div style={{marginTop:'100px'}} id='feed'>
            {
                gameMode === 'normal' ?
                loading ? <CircularProgress size={150} thickness={3} style={{margin:'100px', color: 'white'}}/> 
                :
            ...
            {
                gameMode === 'multi' ?
                multisLoading ? <CircularProgress size={150} thickness={3} style={{margin:'100px', color: 'white'}}/> 
                :
